  ...
  buildRpcHandlers() {
    ...
    return {
      requests: {
        ...
        contextExtract: (p: any) => wrap("contextExtract", r.get("contextExtract"))(p),
        ...
        contextGet: (p: any) => wrap("contextGet", r.get("contextGet"))(p),
        ...
        profileSnapshotSave: (p: any) => wrap("profileSnapshotSave", r.get("profileSnapshotSave"))(p),
      },
    };
  }
